...
public class WordLevelFeature1004 extends WordLevelFeature{

    public WordLevelFeature1004() {
        this.setIndex("WCE1004");
        this.setIdentifier("TRGTRIGRAMLEFT");
        this.setDescription("Trigram at left of target word.");
    }
    ...
    public void run(Sentence source, Sentence target) {
        ...
        for(int i=0; i<tokens.length; i++){
            String ngram = this.getNgram(tokens, i, 2, 0);
